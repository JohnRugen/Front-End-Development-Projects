<?php
// Display different parts of the HTML depending on if the user is logged in as a member or not. The other files within this
// Folder are just for display adn show what it should look like within both conditions.

$user_member = true;

// The solution is to wrap the content with ' if() : ' and then at the end 'endif;'
